        ...
        "config": {
            ...
            "entries": {
                ...
                "variations": [
                    ...
                    # {"weight": 2.0, "state": "farm_and_charm:tomatoes"},
                    # {"weight": 2.0, "state": "farm_and_charm:lettuce"},
                    # {"weight": 2.0, "state": "farm_and_charm:oat"},
                    # {"weight": 2.0, "state": "farm_and_charm:barley"},
                    # {"weight": 1.0, "state": "culturaldelights:cucumber"},
                    # {"weight": 1.0, "state": "culturaldelights:eggplant"},
                    # {"weight": 1.0, "state": "expandeddelight:asparagus"},
                    # {"weight": 1.0, "state": "expandeddelight:chili_pepper"}
                ]
            }
        }
    }
